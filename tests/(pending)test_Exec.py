...
if __name__ == "__main__":
    ...
    while nCH != 99:
        ...
        ################################################
        if nCH == 5:
            from src import FactorAnalysis
            import argparse
        ...
        ################################################
        if nCH == 14:
            from src import xyzReturnOandZ
            import argparse
