...
def test_factor_analysis_miss_args() -> None:
    ...
    with pytest.raises(SystemExit) as e:
        ...
        method_factor_analysis(xyzFile=xyzFile, _factor=0.5)
...
def test_factor_opt() -> None:
    ...
    a0, a1, a2 = method_factor_opt(
        xyzFile=xyzFile, _lowFactor=idx1_minor_factor, table_std=Table_S)  # type: ignore
    assert a0
    assert a1 == [52, 55]
