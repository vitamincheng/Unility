...
def test_factor_analysis():
    ...
    assert Table_S[np.int64(1)] == np.float64(0.41868188431231546)
    assert Table_S[np.int64(61)] == np.float64(3.8871420948650774)
...
def test_method_factor_opt():
    ...
    assert a == (True, [np.int64(52), 55], np.float64(0.9863091021443952))
